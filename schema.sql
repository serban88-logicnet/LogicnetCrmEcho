...
CREATE TABLE `relationship_entities` (
  ...
  `relationship_type` enum('1:N','1:1','N:M') NOT NULL DEFAULT '1:N',
  `parent_label` varchar(255) DEFAULT NULL,
  `child_label` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `parent_entity_id` (`parent_entity_id`),
  KEY `child_entity_id` (`child_entity_id`),
  KEY `company_id` (`company_id`),
  CONSTRAINT `relationship_entities_ibfk_1` FOREIGN KEY (`parent_entity_id`) REFERENCES `entities` (`id`),
  CONSTRAINT `relationship_entities_ibfk_2` FOREIGN KEY (`child_entity_id`) REFERENCES `entities` (`id`),
...
CREATE TABLE `relationship_meta` (
  ...
  CONSTRAINT `relationship_meta_ibfk_1` FOREIGN KEY (`relationship_id`) REFERENCES `relationship_records` (`id`) ON DELETE CASCADE
...
CREATE TABLE `relationship_records` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL,
  `left_record_id` int(11) NOT NULL,
  `right_record_id` int(11) NOT NULL,
  `relationship_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `left_record_id` (`left_record_id`),
  KEY `right_record_id` (`right_record_id`),
  CONSTRAINT `relationship_records_ibfk_1` FOREIGN KEY (`left_record_id`) REFERENCES `records` (`id`) ON DELETE CASCADE,
  CONSTRAINT `relationship_records_ibfk_2` FOREIGN KEY (`right_record_id`) REFERENCES `records` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-07-22 17:26:29
